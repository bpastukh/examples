Feature('Edit/Delete Todos @step-06 @S16f9bd47')
...
Scenario('Edited todo is saved on blur @T3c7b2acc', async ({ I, TodosPage }) => {
...
Scenario('Delete todos @Tc72f8bb0', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
